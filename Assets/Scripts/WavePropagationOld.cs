...
[ExecuteInEditMode]
public class WavePropagationOld : MonoBehaviour
{
    [Header("Buf A")]
    ...
    private void OnPreCull()
    {
        if (m_bufA == null)
        {
            m_bufA = new RenderTexture(Screen.width, Screen.height, 0, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear) { name = "[AutoGenerated]WavePropagation-BufA" };
        }
